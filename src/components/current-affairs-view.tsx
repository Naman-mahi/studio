    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Select a category to get a summary of recent current affairs relevant for RRB NTPC 2025 exams.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              ...
              <Select 
                ...
                onValueChange={(value) => setSelectedCategory(value as CurrentAffairsGeneratorInput['category'])} 
                disabled={isLoading}
              >
                <SelectTrigger id="category" className="w-full md:w-[280px]">
